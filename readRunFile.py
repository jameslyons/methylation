    ...
    try:
        ...
        for rawData in root.find('RawChannels').findall('RawChannel'):
            ...
            # elif rawData.find('Name').text == root.find('Analyses').find('Melt').find('RawChannelRef').text:
                ...
                print(rawData.find('Name').text, 'wasn\'t amp ',
                      root.find('Analyses').find('Quantitate').find('RawChannelRef').text, 'nor melt',
                      root.find('Analyses').find('Melt').find('RawChannelRef').text)
